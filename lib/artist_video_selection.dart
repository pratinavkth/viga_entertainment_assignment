...
class ArtistVideoSelection extends StatefulWidget {
  const ArtistVideoSelection({Key? key}) : super(key: key);
  @override
  State<ArtistVideoSelection> createState() => ArtistVideoSelectScreenState();
}

class ArtistVideoSelectScreenState extends State<ArtistVideoSelection>{
      ...
      builder: (context){
        ...
        return AlertDialog(
          ...
          content: TextField(
            ...
            decoration: const InputDecoration(hintText: 'Paste YouTube Link Here'),
          ),
          actions: [
            TextButton(
      ...
      Column(
        children: [
          ...
          style: ButtonStyle(
           ...
           child: const Text('Select Local Video',
          style: TextStyle(
            fontSize: 20,
            color: Colors.black,
          ...
          style: ButtonStyle(
            minimumSize: WidgetStateProperty.all(const Size(10, 2)),
            backgroundColor: WidgetStateProperty.all(Colors.blue),),
          child: const Text('Select youtube Video',
          style: TextStyle(
            fontSize: 20,
            color: Colors.black,
            fontWeight: FontWeight.bold,),
